function TxRadioFrame=Tx_addPilotSync(Tx,PilotBits,SyncBits,N,M)
...
%%再資料後面加上 Sync+Pilot+Sync

SPS=[QamSyncBits;QamPilotBits;QamSyncBits];
TxRadioFrame=Tx;
TxRadioFrame(NumDataN+1:N,1:size(SPS,2))=SPS;
